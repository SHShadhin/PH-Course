...
const NavBar = () => {
  ...
  console.log('Show me pathname:', pathname)
  const links = (
    <>
      <li>
      ...
      <li>
        <Link
          className={pathname === '/contact/support' ? 'text-blue-600' : ''}
      ...
      <li>
        <Link
          className={pathname === '/blogs' ? 'text-blue-600' : ''}
          href="/blogs"
        >
          Blogs
        </Link>
      ...
      <li>
        <Link
          className={pathname === '/users' ? 'text-blue-600' : ''}
          href="/users"
        >
          Users
        </Link>
